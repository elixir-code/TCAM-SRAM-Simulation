...
#
# Generated by Vivado on Wed Nov 08 23:46:17 IST 2017
# IP Build 1759159 on Thu Jan 26 07:31:30 MST 2017 
#
# usage: BRAM_4x256.sh [-help]
# usage: BRAM_4x256.sh [-lib_map_path]
# usage: BRAM_4x256.sh [-noclean_files]
# usage: BRAM_4x256.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "BRAM_4x256.sh - Script generated by export_simulation (Vivado v2016.4_sdx (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_3_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM_4x256 xil_defaultlib.BRAM_4x256 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim BRAM_4x256 -key {Behavioral:sim_1:Functional:BRAM_4x256} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./BRAM_4x256.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="/home/SDx/2016.4/Vivado/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM_4x256.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./BRAM_4x256.sh -help\" for more information)\n"
    exit 1
  fi
